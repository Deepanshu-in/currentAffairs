          ...
          <ul className="flex flex-col gap-2 p-2 m-2">
            {folders.map((folder, index) => (
              <li key={index} className="mb-4">
                <div
                  className="flex items-center justify-between w-[300px] md:w-[500px] border border-white shadow-lg bg-primaryColor text-white py-2 px-4 rounded-lg cursor-pointer"
